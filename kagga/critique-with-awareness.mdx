...
[^97]: The original has '_dada_', which means 'shore' or 'bank'. In this case, it probably refers to the circular stone structure that is typically built over a well.
