...
[^62]: A dhobi (*agasa* in Kannada) is one who washes clothes. Traditionally, dhobis would use donkevs to transport the clothes from people's houses to the laundry and back
[^63]: The original has the words *daiva* (divine) and *jiva* (human)
