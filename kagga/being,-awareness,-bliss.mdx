...
[^38]: The original has *cinmayateyatmaguna*. The word *cinmayate* is the state of 'being
filled with awareness' or 'being fully alive'. The word *atmaguna* means 'quality of the
self' or 'fundamental human trait'. In Gautama Dharmasutra 1.8.24 we find a mention
of the eight *atmagunas* (compassion to all beings, forbearance, freedom from jealousy,
...
our basic qualities.
[^39]: The original has *saccidananda* (sat + cit + ananda). *Sat* is 'truth', 'reality', or 'goodness'. *Cit* is 'perception', 'awareness,' or 'consciousness'. *Ananda* is happiness', 'bliss' or 'joy'. *Brahman*, 'the supreme being', transcends definition but the Vedanta school of philosophy refers to it as *sat-cit-ananda*.
[^40]: The original has *purnaravi* which literally means 'full sun' or 'complete sun'.
[^41]: The original has *susirapinda*. *Susira* means 'hollow', 'pierced', or 'perforated' while *pinda* means 'ball', 'solid', or 'clod'. *Susirapinda* can also refer to 'wind instrument'.
