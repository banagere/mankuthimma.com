...
The fears and desires of humans -- are these the parents of the _devas_? Does man's cry of devotion arise from the frolic of the _devas_?[^11] Are they testing one another's strengths?[^12] where is _dharma_ in all this?
...
to count the days[^13]. If we know not beginning or end, how can we visualize it? What is the beginning of this universe?
...
[^11]: In other words, "Did human fears and desires give birth to the deities? Does divine fear inspire human devotion?"
[^12]: This line can be interpreted in two ways. One meaning is -- "Are the gods testing the mutual strengths of humans and of nature?" An alternative meaning is -- "Are gods and humans testing each other's strengths?"
[^13]: A reference to the mariner's compass, nautical charts, and other equipment that sailors use to track their journey,
