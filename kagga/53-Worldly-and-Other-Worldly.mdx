...
[^93]: In the original, the poet uses alliteration for the three attributes - ata (play), máta (hasis sorcery) and kata (hassle, disturbance) - in the first line. e also starts the neit "iftarlies with similar sounding words - *uta* (food), *pata* (ability, dexterity), and *patha* (pratice, attainment)