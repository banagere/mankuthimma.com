...
Devas and asuras churned the ocean with all their might but Agastya drank it all up by the power of his tapas. Can lowly ones reach their goals. without struggle? Worldly life is thus[^92].
...
Is this a world of play or magic or hassle?[^93]. Don't refuse food and hospitality. Be able-bodied with an eye on the essence. Always practice balance.
...
[^92]: Devas and asuras churned the cosmic milk-ocean with all their might to get ametd. However, Sage Agastya, by the power of his tapas (literally, 'austerity; 'penance, "heat" effort,' refers to single minded focus on Work) afank Up the Ocean in a single gulp. Life is a struggle for those who lack strength —be it of body, mind, or spirit.
[^93]: In the original, the poet uses alliteration for the three attributes —ata (play), máta (hasis sorcery) and kata (hassle, disturbance) —in the first line. e also starts the neit "iftarlies with similar sounding words —_uta_ (food), _pata_ (ability, dexterity), and _patha_ (pratice, attainment)
